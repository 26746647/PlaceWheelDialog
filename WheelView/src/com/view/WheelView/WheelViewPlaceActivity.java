...
public class WheelViewPlaceActivity extends Activity {
    ...
    private String[] province = new String[20];
    ...
    private void initiWheelView()
    {
        ...
        areaWheelView.setAdapter(new ArrayWheelAdapter<String>(getResources().getStringArray(
        		citytoarea[18][2])));
        areaWheelView.setVisibleItems(5);
        areaWheelView.setCurrentItem(0);

        cityWheelView.setAdapter(new ArrayWheelAdapter<String>(getResources().getStringArray(
                city[18])));
			...
			public void onScrollingFinished(WheelView wheel) {
				...
				switch(wheel.getId()){
				 case 2131099651:
					 ...
					 break;
				 case 2131099652:setArea(provinceId,wheel.getCurrentItem());break;
